					...
					<table align="center" >
						<tr>
							<td>
								<fieldset class="box">
									<table>
										<tr><td><a style="color:red" href="../controller/teacher_table.php">delete from list</a></td></tr>
...
";
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		echo 	"<tr>
					...
					<td>
						<a href=../controller/deleteTeacherDetails.php?username=$username>delete</a>
					</td>
