	...
	<table height="100%" width="100%">
		...
		<tr class="c2">
			...
			<td align="center">
				<table width="45%">
					<tr>
						<th><h2><u>Your Wishlist</u></h2><th>
					</tr>
					<tr align="center">
						<td>
							<input type="text" name="book" id="book">
							<input type="button" name="" value="Add Book" onclick="addwishlist()">
							<input type="button" name="" value="Remove Book" onclick="rmvwishlist()">
							<hr>
						</td>
					</tr>
					<tr>
						<td align="center">
							<ol>
								<?php
									...
									$conn = getConnection();
									$query = "SELECT * FROM wishlist WHERE username='{$_SESSION['username']}'";
