	...
	<table height="100%" width="100%">
		...
		<tr class="c2">
			...
			<td align="center">
				<table width="40%">
					<tr>
						<th><h2><u>Write Your Book Review Here</u></h2><th>
					</tr>
					<tr>
						<td align="center">
						<form method="post" action="../controller/reviewChk.php">
							<b>Book Name : </b><input type="text" name="book"><br><br>
							<b>Your Review : </b><textarea name="review" rows="8" cols="40"></textarea>
						...
						<?php
							if(isset($_GET['msg'])){
								...
								if($msg == "done"){
									echo "Review Submitted !!! Thanks !!!";
								}
								if($msg == "blank"){
									echo "Please give book name and review !!!";
								}
							}
						?>
						</b>
