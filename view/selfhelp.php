	...
	<table height="100%" width="100%">
		...
		<tr class="c2">
			...
			<td align="center">
				<table width="40%">
					<tr>
						<th><h2><u>Self Help Books</u></h2><th>
					</tr>
					<tr align="center">
						<td>
							<input type="text" name="book" id="book" placeholder="Search" onkeyup="selfhelp()">
							<hr>
						</td>
					</tr>
					<tr>
							...
							<ol>
								<b id="result">
									<?php
										...
										$conn = getConnection();
										$query = "SELECT bookname FROM books WHERE category='self help'";
