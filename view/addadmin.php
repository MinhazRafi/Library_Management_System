...
<body>
	<form method="post" action="../controller/addadmin_check.php" onsubmit="return validation()">
	<table width="50%">
		<tr>
			<td>
		<fieldset class="box">
	...
	<table width="100%">
		...
		<tr>
			<td valign="top" width="40%">
				<details>
					...
					<a href="../view/addadmin.php">Add Teacher</a>
		...
		<td colspan="2">
		<fieldset>
			<legend style="color: red">Add Admin</legend>
								<label>username:</label>&nbsp<input id="inuser" type="text" name="username" onkeyup=" usernotnull()"><br>
