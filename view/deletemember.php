					...
					<table align="center" >
						<tr>
							<td>
								<fieldset class="box">
									<table>
										<tr><td><a style="color:red" href="../controller/member_table.php">delete from list</a></td></tr>
										<tr><tr><td class="label">Search by username</td></tr>
										<tr>
											<td><input type="text" name="search" id="search" value="" onkeyup="ajax()"></td>
										</tr>
										<tr>
...
";
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		echo 	"<tr>
					...
					<td>
						<a href=../controller/deleteMemberDetails.php?username=$username>delete</a>
					</td>
