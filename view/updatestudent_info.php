					...
					<table align="center" >
						<tr>
							<td>
								<fieldset class="box">
									<table>
										<tr><td><a style="color:red" href="../controller/updatestudent_table.php">Update from list</a></td></tr>
...
";
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		echo 	"<tr>
					...
					<td>
						<a href=../controller/updateStudentDetails.php?username=$username>Update</a>
					</td>
